/*******************************************************************************
*  Benchmark for sequential matrix multiplication with a triple nested loop 
********************************************************************************/
...
int main()
{
   ...
   s_initial = get_time();
    ...
    printf (" == Matrix multiplication using triple nested loop: C=A*B, A(%i,%i) and B(%i,%i)== \n"
            " == Execution Time = %.5f seconds == \n == Performance in FLOPS = %.5f GFLOPS == \n\n", m, n, n, p, s_elapsed, flops);
