/**********************************************************************
*  Benchmark for parallel matrix multiplication using MKL library
***********************************************************************/
...
int main()
{
    ...
    //Set up MKL to use max_threads number of threads
    ...
    printf (" Matrix multiplication using MKL dgemm in parallel with %d threads: C=A*B, A(%i,%i) and B(%i,%i) \n"
            "  Execution time = %.5f seconds == \n  Performance in GFLOPS = %.5f GFLOPS \n\n", max_threads, m, p, p, n, s_elapsed, flops);
